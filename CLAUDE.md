...
- Версии: **бэк 1.22.3, фронт 1.30.1**.
- **В работе — волна 03 «PRIME»** (тёмное стекло над лентой прожитых дней, DESIGN §10.2).
  Едет тремя ветками: холст → стекло на плитках → доводка под тёмное. Волна неактивна,
  смотреть через переключатель волн. Пер-тайл эталоны Playwright её **не покрывают**:
  блюр рендерится по-разному на GPU и в headless, канон остаётся за волной 01.
