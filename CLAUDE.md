...
- Версии: **бэк 1.22.6, фронт 1.31.0**.
- **В работе — волна 03 «PRIME»** (тёмное стекло над лентой прожитых дней, DESIGN §10.2).
  ...
  **не покрывают**: блюр рендерится по-разному на GPU и в headless, канон остаётся за волной 01.
  На борд начали возвращаться виджеты — первым приехала музыка.
...
- **Виджет музыки одевается по режиму** (`data-music-mode`), и его слои (подложка-обложка,
  знак Spotify, шкала головки, ссылка по кадру) по умолчанию **выключены** — включает волна.
  Это защищает эталоны волны 01 от чужих правок.
