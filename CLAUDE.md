...
- Версии: **бэк 1.16.2, фронт 1.23.6**.
...
postgres `localhost:5432`. Это **build-образы**, не dev-серверы: hot reload нет, правки кода
видны только после пересборки. Данные (тома `pgdata`, `filmdata`) пересборку переживают.
