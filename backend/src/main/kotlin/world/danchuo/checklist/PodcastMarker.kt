 ...
 *
 * **Приоритет ручного ввода сохранён** (решение владельца: интерактивный шорткат остаётся
 * каналом и всегда главнее). Прислал отметку с телефона — строка становится ручной, и поллер её
