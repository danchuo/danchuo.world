 ...
 *
 * **Времени начала захода здесь нет** (решение владельца): «во сколько включил» — не тот
 ...
 *
 * **Минут эпизода за сутки тут тоже больше нет.** Строка «80 из 85 мин за день» защищала от
 * прочтения «эпизод брошен на середине», когда карточка знала только «45 из 85». Теперь она
 * говорит, какой именно кусок пройден ([startMinute] → [endMinute]), и спутать заход с
 * брошенным эпизодом больше нечем — защита стала лишней вместе со своей причиной.
 */
@RegisterForReflection
