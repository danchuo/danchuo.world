...
interface ReadingConfig {
    ...
    interface Summary {
        ...
        /**
         * На сколько долей книги заход должен уйти вперёд от рассказанного, чтобы пересказ
         * пересобрали. По умолчанию 0.02 — два процента книги: заход, продлённый на столько,
         * это уже другая история, а меньшее не отличить от округления процента у читалки.
         * Ноль здесь означал бы поход к модели на каждый такт поллера.
         */
        @WithDefault("0.02")
        fun refreshPercent(): Double
    }
}
