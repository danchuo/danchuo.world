...
class PodcastSession {
     ...
     *
     * `null` — резать нечего, и такому заходу пересказ не положен. У строк, записанных до
     * появления колонки, начало восстановлено миграциями (0430/0440): там, где зачёт равен
     * положению головки, — точно; у продолженных с середины — разницей, и это лучшее
     * утверждение о куске, какое у нас есть (PRD §5.16.2).
     */
