...
/**
 * Цвет фазы — токены волны (rem — акцент, deep — глина, light — графит, пробуждение — тише всех).
 * Общий и для баров долей, и для полосы ночи: одна фаза не может быть двух цветов в одной плитке.
 */
export const STAGE_COLOR: Record<SleepStageKey, string> = {
  rem: "var(--accent)",
  deep: "var(--border-tile)",
  light: "var(--text-secondary)",
  awake: "var(--text-tertiary)",
};
