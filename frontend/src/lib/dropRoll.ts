 ...
 *
 * На телефоне гребёнка и полоса миниатюр — цели шириной в несколько миллиметров, а самый
 * большой объект на экране, кадр, до сих пор на жест не отвечал вовсе. Теперь отвечает: лента
 * листается тем же движением, которым листают что угодно на телефоне.
 *
