 ...
 * дельты убывают). Первый вариант продлевал её любым событием, и календарь «крутился туго»
 * (замечание владельца): ровное движение двумя пальцами после первого шага молча глоталось,
 * пока пальцы не остановятся. Теперь растущая дельта — это новый толчок, она копится, а
 * убывающая — хвост, он глотается. Рассмотрено и отклонено: фиксированная блокировка без
 * продления — хвост инерции за неё не гаснет, и прилетал второй шаг.
 */
